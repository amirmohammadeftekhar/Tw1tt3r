...
public class ProfileController extends AbstractController implements Initializable {
    ...
    public void reload() {
        ...
        PersonDto finalCurrentPerson = currentPerson;
        TransactionServiceGenerator.getInstance().createService(ProfileControllerService.class).reload(currentPersonId).enqueue(new TransactionCallBack<BaseResponse>() {
            ...
            public void DoOnResponse(Response<BaseResponse> response) {
                ...
                userNameLabel.setText(finalCurrentPerson.getUserName());
                nameLabel.setText(finalCurrentPerson.getFirstname() + " " + finalCurrentPerson.getLastName());
                mailLabel.setText(finalCurrentPerson.getEmailAddress());
                ...
                if(finalCurrentPerson.getPicture() != null){
                    profileImage.setImage(ViewUtility.getPicture(finalCurrentPerson.getPicture().getId()));
                }
                int t_followers = 0;
