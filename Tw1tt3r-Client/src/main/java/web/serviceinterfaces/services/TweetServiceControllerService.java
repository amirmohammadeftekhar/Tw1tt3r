...
public interface TweetServiceControllerService {
    ...
    public Call<Void> makeTweet(@Query("text") String text, @Query("parentTweetId") int parentTweetId, @Query("currentPersonId") int currentPersonId, @Body PictureDto pictureDto);
